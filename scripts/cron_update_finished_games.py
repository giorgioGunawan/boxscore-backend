#!/usr/bin/env python3
"""
Standalone script to update finished games.
...
async def main():
    ...
    async with AsyncSessionLocal() as db:
        ...
        run = CronRun(
            job_id=1,  # Assuming job_id 1 is update_finished_games
            job_name="update_finished_games",
        ...
        try:
            # Run the job
            result = await CronService.update_finished_games(
                run_id=run.id,
